...
cond_stage_config_list = {
    "__is_first_stage__", "__is_unconditional__","__is_unconditional__kmeans" # TODO: and other ckpt path
}  # used for initialize condition encoder model

cond_stage_key_list = {
    'unconditional', 'masked_graph', 'prompt_graph', 'prefix', 'class_label', 'multi-modal', 'pe', 'kmeans'
}  # condition types
