...
from geomancer.layer.multi_model_layer import MultiLayer, SingleLayer
from geomancer.encoder.ER_edge_encoder import EREdgeEncoder
from geomancer.encoder.exp_edge_fixer import ExpanderEdgeFixer
from .utils import *
...
class MultiModel_curv(torch.nn.Module):
    """Multiple layer types can be combined here.
    """
    ...
    def __init__(self, dim_in=cfg.share.dim_in, dim_out=cfg.share.dim_out, cfg=None):
        ...
        if cfg.rm_encode:
            ...
            if cfg.encode_batch_norm:
                self.encode_kernel_norm_node = nn.BatchNorm1d(self.out_dim, track_running_stats=not self.bn_no_runner, eps=1e-5,
    ...
    def encode_node_curv(self,node_attr):
        ...
        # if self.res:
        #     embeds_tensor = embeds_tensor + node_attr
...
register_network('MultiModel_curv', MultiModel_curv)
