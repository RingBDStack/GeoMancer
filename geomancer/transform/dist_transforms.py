...
def my_toundirected(data):
   edge_list = to_undirected(data.edge_index)
   data.edge_index = edge_list
   return data
def my_remove_loops(data):
   edge_list = remove_self_loops(data.edge_index)
   data.edge_index = edge_list
   return data
# def my_add_loops(data):
#    edge_list,_ = add_self_loops(data.edge_index,num_nodes=data.x[0])
#    data.edge_index = edge_list
#    return data
